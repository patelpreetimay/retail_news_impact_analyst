...
EVENT_DESCRIPTIONS = {
    ...
    "macroeconomic_geopolitical":        "a macroeconomic or geopolitical",
    "market_sentiment_investor_action":  "a market sentiment and investor action",
    "other":                             "a general financial",
    # Legacy V1 names (backward compat)
    "market_movement":                   "a stock market movement or trading activity",
    "unclassified":                      "an unclassified or general financial",
}
...
STANCE_DESCRIPTORS = {
    ...
    "mixed": {
        "sentiment": "mixed",
        "implication": "both positive and negative factors present",
        "tone": "balanced",
    },
    # Legacy V1 names (backward compat)
    "positive": {
